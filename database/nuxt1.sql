...
--
-- Host: mysql
-- Generation Time: Jan 09, 2026 at 07:23 AM
...
(4, 5, 2, 'y', 'ประธาน', 'yyyyy', NULL),
(5, 6, 2, 'n', 'กรรมการ', NULL, NULL),
(6, 7, 2, 'n', 'เลขา', NULL, NULL);
...
(1, 3, 1, '2026-03-03', 0.00, 0.00, 1),
(2, 4, 1, '2026-01-08', 40.00, 45.00, 2);
...
(2, 1, '1', 1, NULL, 'ไม่เอาเหี้ยไรเลย ', '1767859612788phw0040jstj.jpg'),
(2, 2, '1', 2, NULL, 'บ้านอยู่ไกล', NULL),
(2, 3, '1', 2, NULL, 'แล้วแต่กิจและดุจพินิ', '1767859612800y17xueyqdxg.jpg'),
(2, 4, '1', 3, NULL, 'มีแค่ปัจจุบัน', '1767859612800vk0thjkg82.jpg'),
(2, 1, '2', NULL, 4, NULL, NULL),
(2, 2, '2', NULL, 2, NULL, NULL),
(2, 3, '2', NULL, 1, NULL, NULL),
(2, 4, '2', NULL, 2, NULL, NULL);
...
(1, 'rrrr', 'rrrr', 'eeee', '$2b$10$JpPuxEl3UI3MPbUw.PSit.ezy080a1AgsEcS1qwpXH4wehHRkHexa', 'eeeeee@gmail.com', 'ผู้รับการประเมินผล'),
...
(4, 'บีม', 'สุดหล่อ', 'been', '$2b$10$u1viWNUavCf8Pb/Hm5l8POT2U/Lsmzdrxz.zptBJJj4ppRiFGJijq', 'been@gamil.com', 'ผู้รับการประเมินผล'),
(5, 'ssss', 'ssss', 'ssss', '$2b$10$Died9jt.y16DjLGAZpwLMewzJKvZjLLSceE5KXxbA3Nn/CJRCRViK', 'ssss@gmail.com', 'กรรมการประเมิน'),
(6, 'dddd', 'dddd', 'dddd', '$2b$10$MBWhH.p/u3c1vhYQSr3Uo.ANP1M2hTbDdfwaI/4Ih.Tx/nqx2iKFC', 'dddd@gmail.com', 'กรรมการประเมิน'),
(7, 'ffff', 'ffff', 'ffff', '$2b$10$IOMCl6nCJDCMeQR6ZwdPQuESm5Xlp7Ry7u/M.NmgOR78g2uq.NzLO', 'ffff@gmail.com', 'กรรมการประเมิน');
